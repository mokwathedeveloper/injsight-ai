# InjSight AI UX/UI Specification — Injective Transaction Activity

## 1. Feature Overview

**Feature:** Injective Transaction Activity  
**Category:** Activity timeline  
**Primary Route / Placement:** `/dashboard/wallets/[id]/activity`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Show recent transfers, DeFi activity, and large movements.
...
Once you use Injective Transaction Activity, relevant wallet intelligence will appear here.
...
```ts
export interface InjectiveTransactionActivityProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/InjectiveTransactionActivity.tsx
frontend/types/injective_transaction_activity.ts
frontend/data/mock_injective_transaction_activity.ts
```
