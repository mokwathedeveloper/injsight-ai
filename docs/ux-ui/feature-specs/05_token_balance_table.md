# InjSight AI UX/UI Specification — Token Balance Table

## 1. Feature Overview

**Feature:** Token Balance Table  
**Category:** Asset table  
**Primary Route / Placement:** `Reusable component`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Display wallet token balances in a clean, readable, sortable format.
...
Once you use Token Balance Table, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/TokenBalanceTable.tsx
frontend/types/token_balance_table.ts
frontend/data/mock_token_balance_table.ts
```
