# InjSight AI UX/UI Specification — Wallet Risk Score

## 1. Feature Overview

**Feature:** Wallet Risk Score  
**Category:** Risk scoring UI  
**Primary Route / Placement:** `/risk/[id]`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Display wallet risk score, level, dimensions, and methodology note.
...
Once you use Wallet Risk Score, relevant wallet intelligence will appear here.
...
```ts
export interface WalletRiskScoreProps {
  className?: string;
}
...
```txt
frontend/components/wallet/WalletRiskScore.tsx
frontend/types/wallet_risk_score.ts
frontend/data/mock_wallet_risk_score.ts
```
