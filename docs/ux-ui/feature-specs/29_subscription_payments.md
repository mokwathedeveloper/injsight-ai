# InjSight AI UX/UI Specification — Subscription Payments

## 1. Feature Overview

**Feature:** Subscription Payments  
**Category:** Payment flow  
**Primary Route / Placement:** `Future payment flow`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Handle Stripe and future crypto payment flows safely.
...
Once you use Subscription Payments, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/SubscriptionPayments.tsx
frontend/types/subscription_payments.ts
frontend/data/mock_subscription_payments.ts
```
