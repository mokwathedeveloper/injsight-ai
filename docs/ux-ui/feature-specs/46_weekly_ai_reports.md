# InjSight AI UX/UI Specification — Weekly AI Reports

## 1. Feature Overview

**Feature:** Weekly AI Reports  
**Category:** Recurring intelligence  
**Primary Route / Placement:** `/dashboard/reports/weekly`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Provide weekly summaries of saved wallet changes.
...
Once you use Weekly AI Reports, relevant wallet intelligence will appear here.
...
```ts
export interface WeeklyAiReportsProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/WeeklyAiReports.tsx
frontend/types/weekly_ai_reports.ts
frontend/data/mock_weekly_ai_reports.ts
```
