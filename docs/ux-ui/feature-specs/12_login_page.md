# InjSight AI UX/UI Specification — Login Page

## 1. Feature Overview

**Feature:** Login Page  
**Category:** Returning user auth  
**Primary Route / Placement:** `/login`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Let users access saved wallets, reports, alerts, and dashboard.
...
Once you use Login Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/LoginPage.tsx
frontend/types/login_page.ts
frontend/data/mock_login_page.ts
```
