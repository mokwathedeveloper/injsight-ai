# InjSight AI UX/UI Specification — Watchlist

## 1. Feature Overview

**Feature:** Watchlist  
**Category:** Wallet monitoring  
**Primary Route / Placement:** `/dashboard/watchlist`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Allow users to monitor selected wallets for changes and risk events.
...
Once you use Watchlist, relevant wallet intelligence will appear here.
...
frontend/data/mock_watchlist.ts
```
