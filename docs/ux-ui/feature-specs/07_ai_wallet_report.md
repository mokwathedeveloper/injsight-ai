# InjSight AI UX/UI Specification — AI Wallet Report

## 1. Feature Overview

**Feature:** AI Wallet Report  
**Category:** Core AI output  
**Primary Route / Placement:** `/report/[id]`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Render structured AI-generated wallet insights and explanations.
...
Once you use AI Wallet Report, relevant wallet intelligence will appear here.
...
```ts
export interface AiWalletReportProps {
  className?: string;
}
...
```txt
frontend/components/wallet/AiWalletReport.tsx
frontend/types/ai_wallet_report.ts
frontend/data/mock_ai_wallet_report.ts
```
