# InjSight AI UX/UI Specification — Reports Page

## 1. Feature Overview

**Feature:** Reports Page  
**Category:** Report management  
**Primary Route / Placement:** `/dashboard/reports`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

List, filter, view, export, and delete generated reports.
...
Once you use Reports Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/ReportsPage.tsx
frontend/types/reports_page.ts
frontend/data/mock_reports_page.ts
```
