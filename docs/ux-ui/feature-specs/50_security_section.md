# InjSight AI UX/UI Specification — Security Section

## 1. Feature Overview

**Feature:** Security Section  
**Category:** Trust section  
**Primary Route / Placement:** `/security or landing section`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Explain read-only architecture, no custody, and AI safety.
...
Once you use Security Section, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/SecuritySection.tsx
frontend/types/security_section.ts
frontend/data/mock_security_section.ts
```
