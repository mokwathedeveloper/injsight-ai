# InjSight AI UX/UI Specification — Wallet Analyzer

## 1. Feature Overview

**Feature:** Wallet Analyzer  
**Category:** Core public product feature  
**Primary Route / Placement:** `/analyze`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Let a user paste an Injective wallet address and receive wallet intelligence.
...
Once you use Wallet Analyzer, relevant wallet intelligence will appear here.
...
```txt
frontend/components/wallet/WalletAnalyzer.tsx
frontend/types/wallet_analyzer.ts
frontend/data/mock_wallet_analyzer.ts
```
