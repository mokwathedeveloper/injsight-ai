# InjSight AI UX/UI Specification — AI Risk Explanation

## 1. Feature Overview

**Feature:** AI Risk Explanation  
**Category:** AI risk narrative  
...
Explain why the wallet received its risk score.
...
Once you use AI Risk Explanation, relevant wallet intelligence will appear here.
...
```ts
export interface AiRiskExplanationProps {
  className?: string;
}
...
```txt
frontend/components/wallet/AiRiskExplanation.tsx
frontend/types/ai_risk_explanation.ts
frontend/data/mock_ai_risk_explanation.ts
```
