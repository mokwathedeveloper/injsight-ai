# InjSight AI UX/UI Specification — Financial Disclaimer

## 1. Feature Overview

**Feature:** Financial Disclaimer  
**Category:** Compliance copy  
...
Display informational-only disclaimer in reports and analysis flows.
...
Once you use Financial Disclaimer, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/FinancialDisclaimer.tsx
frontend/types/financial_disclaimer.ts
frontend/data/mock_financial_disclaimer.ts
```
