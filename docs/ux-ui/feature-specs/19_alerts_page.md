# InjSight AI UX/UI Specification — Alerts Page

## 1. Feature Overview

**Feature:** Alerts Page  
**Category:** Alert history and management  
...
Show risk, watchlist, movement, and report alerts.
...
Once you use Alerts Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/AlertsPage.tsx
frontend/types/alerts_page.ts
frontend/data/mock_alerts_page.ts
```
