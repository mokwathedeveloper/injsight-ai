# InjSight AI UX/UI Specification — Team Member Roles

## 1. Feature Overview

**Feature:** Team Member Roles  
**Category:** Access control UI  
**Primary Route / Placement:** `/dashboard/team/members`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Manage owner, admin, analyst, and viewer roles.
...
Once you use Team Member Roles, relevant wallet intelligence will appear here.
...
```ts
export interface TeamMemberRolesProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/TeamMemberRoles.tsx
frontend/types/team_member_roles.ts
frontend/data/mock_team_member_roles.ts
```
