# InjSight AI UX/UI Specification — Settings Page

## 1. Feature Overview

**Feature:** Settings Page  
**Category:** Account settings  
**Primary Route / Placement:** `/dashboard/settings`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Let users manage profile, password, notifications, and data controls.
...
Once you use Settings Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/SettingsPage.tsx
frontend/types/settings_page.ts
frontend/data/mock_settings_page.ts
```
