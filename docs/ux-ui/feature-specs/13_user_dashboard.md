# InjSight AI UX/UI Specification — User Dashboard

## 1. Feature Overview

**Feature:** User Dashboard  
**Category:** Logged-in command center  
**Primary Route / Placement:** `/dashboard`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Show wallet intelligence summary, saved wallets, risk, alerts, and recent reports.
...
Once you use User Dashboard, relevant wallet intelligence will appear here.
...
frontend/types/user_dashboard.ts
frontend/data/mock_user_dashboard.ts
```
