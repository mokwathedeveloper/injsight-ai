# InjSight AI UX/UI Specification — Data Privacy Controls

## 1. Feature Overview

**Feature:** Data Privacy Controls  
**Category:** User data control  
**Primary Route / Placement:** `/dashboard/settings/privacy`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Allow users to delete saved wallets, reports, and account data.
...
Once you use Data Privacy Controls, relevant wallet intelligence will appear here.
...
```ts
export interface DataPrivacyControlsProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/DataPrivacyControls.tsx
frontend/types/data_privacy_controls.ts
frontend/data/mock_data_privacy_controls.ts
```
