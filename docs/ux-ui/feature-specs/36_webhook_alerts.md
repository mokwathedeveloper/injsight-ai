# InjSight AI UX/UI Specification — Webhook Alerts

## 1. Feature Overview

**Feature:** Webhook Alerts  
**Category:** External notification integration  
**Primary Route / Placement:** `/dashboard/webhooks`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Allow teams to receive events through webhooks.
...
Once you use Webhook Alerts, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/WebhookAlerts.tsx
frontend/types/webhook_alerts.ts
frontend/data/mock_webhook_alerts.ts
```
