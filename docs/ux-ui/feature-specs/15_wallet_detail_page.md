# InjSight AI UX/UI Specification — Wallet Detail Page

## 1. Feature Overview

**Feature:** Wallet Detail Page  
**Category:** Single-wallet intelligence view  
**Primary Route / Placement:** `/dashboard/wallets/[id]`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Show detailed current and historical intelligence for one saved wallet.
...
Once you use Wallet Detail Page, relevant wallet intelligence will appear here.
...
```ts
export interface WalletDetailPageProps {
  className?: string;
}
...
```txt
frontend/components/wallet/WalletDetailPage.tsx
frontend/types/wallet_detail_page.ts
frontend/data/mock_wallet_detail_page.ts
```
