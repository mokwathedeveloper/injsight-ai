# InjSight AI UX/UI Specification — Admin Dashboard

## 1. Feature Overview

**Feature:** Admin Dashboard  
**Category:** Internal operations  
**Primary Route / Placement:** `/admin`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Monitor users, usage, failures, AI costs, and system health.
...
Once you use Admin Dashboard, relevant wallet intelligence will appear here.
...
frontend/types/admin_dashboard.ts
frontend/data/mock_admin_dashboard.ts
```
