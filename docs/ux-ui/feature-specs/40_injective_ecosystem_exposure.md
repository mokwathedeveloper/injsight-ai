# InjSight AI UX/UI Specification — Injective Ecosystem Exposure

## 1. Feature Overview

**Feature:** Injective Ecosystem Exposure  
**Category:** Ecosystem analysis  
**Primary Route / Placement:** `Reusable section`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Explain wallet exposure to INJ, native assets, stablecoins, and unknown tokens.
...
Once you use Injective Ecosystem Exposure, relevant wallet intelligence will appear here.
...
```ts
export interface InjectiveEcosystemExposureProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/InjectiveEcosystemExposure.tsx
frontend/types/injective_ecosystem_exposure.ts
frontend/data/mock_injective_ecosystem_exposure.ts
```
