# InjSight AI UX/UI Specification — Portfolio Composition

## 1. Feature Overview

**Feature:** Portfolio Composition  
**Category:** Asset allocation view  
**Primary Route / Placement:** `/portfolio/[id]`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Visualize asset allocation, stablecoin exposure, and concentration warnings.
...
Once you use Portfolio Composition, relevant wallet intelligence will appear here.
...
```txt
frontend/components/wallet/PortfolioComposition.tsx
frontend/types/portfolio_composition.ts
frontend/data/mock_portfolio_composition.ts
```
