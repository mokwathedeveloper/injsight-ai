# InjSight AI UX/UI Specification — Ask Your Wallet Chat

## 1. Feature Overview

**Feature:** Ask Your Wallet Chat  
**Category:** Future AI chat  
**Primary Route / Placement:** `/dashboard/wallets/[id]/ask`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Let users ask questions about a wallet or report.
...
Once you use Ask Your Wallet Chat, relevant wallet intelligence will appear here.
...
```ts
export interface AskYourWalletChatProps {
  className?: string;
}
...
```txt
frontend/components/wallet/AskYourWalletChat.tsx
frontend/types/ask_your_wallet_chat.ts
frontend/data/mock_ask_your_wallet_chat.ts
```
