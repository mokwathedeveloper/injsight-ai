# InjSight AI UX/UI Specification — Export Reports

## 1. Feature Overview

**Feature:** Export Reports  
**Category:** Report download  
**Primary Route / Placement:** `Modal workflow`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Export wallet intelligence reports as PDF, CSV, JSON, or Markdown later.
...
Once you use Export Reports, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/ExportReports.tsx
frontend/types/export_reports.ts
frontend/data/mock_export_reports.ts
```
