# InjSight AI UX/UI Specification — Suggested Next Steps

## 1. Feature Overview

**Feature:** Suggested Next Steps  
...
Provide practical next actions without giving financial advice.
...
Once you use Suggested Next Steps, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/SuggestedNextSteps.tsx
frontend/types/suggested_next_steps.ts
frontend/data/mock_suggested_next_steps.ts
```
