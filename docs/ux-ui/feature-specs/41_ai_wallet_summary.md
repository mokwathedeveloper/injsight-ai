# InjSight AI UX/UI Specification — AI Wallet Summary

## 1. Feature Overview

**Feature:** AI Wallet Summary  
**Category:** AI summary  
...
Explain the wallet in plain English.
...
Once you use AI Wallet Summary, relevant wallet intelligence will appear here.
...
```ts
export interface AiWalletSummaryProps {
  className?: string;
}
...
```txt
frontend/components/wallet/AiWalletSummary.tsx
frontend/types/ai_wallet_summary.ts
frontend/data/mock_ai_wallet_summary.ts
```
