# InjSight AI UX/UI Specification — Saved Wallets

## 1. Feature Overview

**Feature:** Saved Wallets  
**Category:** Wallet management  
**Primary Route / Placement:** `/dashboard/wallets`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Let users save, label, re-analyze, and remove Injective wallets.
...
Once you use Saved Wallets, relevant wallet intelligence will appear here.
...
```ts
export interface SavedWalletsProps {
  className?: string;
}
...
```txt
frontend/components/wallet/SavedWallets.tsx
frontend/types/saved_wallets.ts
frontend/data/mock_saved_wallets.ts
```
