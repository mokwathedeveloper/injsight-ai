# InjSight AI UX/UI Specification — Demo Wallet Mode

## 1. Feature Overview

**Feature:** Demo Wallet Mode  
**Category:** Demo experience  
**Primary Route / Placement:** `/demo`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Let users, judges, and investors experience the product without a real wallet.
...
Once you use Demo Wallet Mode, relevant wallet intelligence will appear here.
...
```ts
export interface DemoWalletModeProps {
  className?: string;
}
...
```txt
frontend/components/wallet/DemoWalletMode.tsx
frontend/types/demo_wallet_mode.ts
frontend/data/mock_demo_wallet_mode.ts
```
