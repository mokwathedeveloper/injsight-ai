# InjSight AI UX/UI Specification — Treasury Monitoring

## 1. Feature Overview

**Feature:** Treasury Monitoring  
**Category:** DAO/protocol wallet monitoring  
**Primary Route / Placement:** `/dashboard/treasury`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Track treasury wallets, movement, concentration, and weekly reports.
...
Once you use Treasury Monitoring, relevant wallet intelligence will appear here.
...
```ts
export interface TreasuryMonitoringProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/TreasuryMonitoring.tsx
frontend/types/treasury_monitoring.ts
frontend/data/mock_treasury_monitoring.ts
```
