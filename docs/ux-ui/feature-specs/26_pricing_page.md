# InjSight AI UX/UI Specification — Pricing Page

## 1. Feature Overview

**Feature:** Pricing Page  
**Category:** SaaS pricing  
**Primary Route / Placement:** `/pricing`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Show Free, Pro, Team, and Enterprise plans clearly.
...
Once you use Pricing Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/PricingPage.tsx
frontend/types/pricing_page.ts
frontend/data/mock_pricing_page.ts
```
