# InjSight AI UX/UI Specification — Plan Limits
...
Display and enforce plan-based usage limits.
...
Once you use Plan Limits, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/PlanLimits.tsx
frontend/types/plan_limits.ts
frontend/data/mock_plan_limits.ts
```
