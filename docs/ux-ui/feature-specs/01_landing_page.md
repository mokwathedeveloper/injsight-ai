# InjSight AI UX/UI Specification — Landing Page

## 1. Feature Overview

**Feature:** Landing Page  
**Category:** Public marketing page  
**Primary Route / Placement:** `/`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Communicate product value and drive users to analyze a wallet.
...
Once you use Landing Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/LandingPage.tsx
frontend/types/landing_page.ts
frontend/data/mock_landing_page.ts
```
