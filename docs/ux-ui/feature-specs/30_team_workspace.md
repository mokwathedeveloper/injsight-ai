# InjSight AI UX/UI Specification — Team Workspace

## 1. Feature Overview

**Feature:** Team Workspace  
**Category:** Team SaaS  
**Primary Route / Placement:** `/dashboard/team`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Support shared wallets, reports, alerts, and users for teams.
...
Once you use Team Workspace, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/TeamWorkspace.tsx
frontend/types/team_workspace.ts
frontend/data/mock_team_workspace.ts
```
