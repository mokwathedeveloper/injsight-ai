# InjSight AI UX/UI Specification — Billing Page

## 1. Feature Overview

**Feature:** Billing Page  
**Category:** Subscription management  
**Primary Route / Placement:** `/dashboard/billing`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Show current plan, usage, billing history, and upgrade path.
...
Once you use Billing Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/BillingPage.tsx
frontend/types/billing_page.ts
frontend/data/mock_billing_page.ts
```
