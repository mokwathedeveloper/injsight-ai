# InjSight AI UX/UI Specification — Report Detail Page

## 1. Feature Overview

**Feature:** Report Detail Page  
**Category:** Full report view  
**Primary Route / Placement:** `/dashboard/reports/[id]`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Display a complete AI wallet intelligence report with export and save actions.
...
Once you use Report Detail Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/ReportDetailPage.tsx
frontend/types/report_detail_page.ts
frontend/data/mock_report_detail_page.ts
```
