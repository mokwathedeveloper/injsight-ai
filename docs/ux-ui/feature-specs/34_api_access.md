# InjSight AI UX/UI Specification — API Access
...
Let developers access wallet intelligence endpoints with API keys.
...
Once you use API Access, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/ApiAccess.tsx
frontend/types/api_access.ts
frontend/data/mock_api_access.ts
```
