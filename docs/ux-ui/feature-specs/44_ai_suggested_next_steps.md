# InjSight AI UX/UI Specification — AI Suggested Next Steps

## 1. Feature Overview

**Feature:** AI Suggested Next Steps  
...
Provide helpful, non-custodial next steps.
...
Once you use AI Suggested Next Steps, relevant wallet intelligence will appear here.
...
```ts
export interface AiSuggestedNextStepsProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/AiSuggestedNextSteps.tsx
frontend/types/ai_suggested_next_steps.ts
frontend/data/mock_ai_suggested_next_steps.ts
```
