# InjSight AI UX/UI Specification — Portfolio Summary

## 1. Feature Overview

**Feature:** Portfolio Summary  
**Category:** Wallet overview  
**Primary Route / Placement:** `/analyze or /dashboard/wallets/[id]`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Summarize a wallet’s visible portfolio, top assets, and high-level exposure.
...
Once you use Portfolio Summary, relevant wallet intelligence will appear here.
...
```txt
frontend/components/wallet/PortfolioSummary.tsx
frontend/types/portfolio_summary.ts
frontend/data/mock_portfolio_summary.ts
```
