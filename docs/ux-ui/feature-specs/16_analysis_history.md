# InjSight AI UX/UI Specification — Analysis History

## 1. Feature Overview

**Feature:** Analysis History  
**Category:** Historical analysis records  
**Primary Route / Placement:** `/dashboard/history`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

List previous wallet analyses with status, risk, and actions.
...
Once you use Analysis History, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/AnalysisHistory.tsx
frontend/types/analysis_history.ts
frontend/data/mock_analysis_history.ts
```
