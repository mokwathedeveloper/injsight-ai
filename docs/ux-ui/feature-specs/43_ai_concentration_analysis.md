# InjSight AI UX/UI Specification — AI Concentration Analysis

## 1. Feature Overview

**Feature:** AI Concentration Analysis  
**Category:** AI concentration narrative  
**Primary Route / Placement:** `AI report section`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Explain top-asset concentration and diversification concerns.
...
Once you use AI Concentration Analysis, relevant wallet intelligence will appear here.
...
```ts
export interface AiConcentrationAnalysisProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/AiConcentrationAnalysis.tsx
frontend/types/ai_concentration_analysis.ts
frontend/data/mock_ai_concentration_analysis.ts
```
