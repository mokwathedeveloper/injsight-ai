# InjSight AI UX/UI Specification — Shared Watchlists

## 1. Feature Overview

**Feature:** Shared Watchlists  
**Category:** Team monitoring  
**Primary Route / Placement:** `/dashboard/team/watchlists`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Allow teams to share wallet watchlists and alerts.
...
Once you use Shared Watchlists, relevant wallet intelligence will appear here.
...
```ts
export interface SharedWatchlistsProps {
  className?: string;
}
...
```txt
frontend/components/dashboard/SharedWatchlists.tsx
frontend/types/shared_watchlists.ts
frontend/data/mock_shared_watchlists.ts
```
