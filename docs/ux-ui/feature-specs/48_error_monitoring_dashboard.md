# InjSight AI UX/UI Specification — Error Monitoring Dashboard

## 1. Feature Overview

**Feature:** Error Monitoring Dashboard  
**Category:** Internal reliability  
**Primary Route / Placement:** `/admin/errors`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Track failed analyses, provider errors, and AI failures.
...
Once you use Error Monitoring Dashboard, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/ErrorMonitoringDashboard.tsx
frontend/types/error_monitoring_dashboard.ts
frontend/data/mock_error_monitoring_dashboard.ts
```
