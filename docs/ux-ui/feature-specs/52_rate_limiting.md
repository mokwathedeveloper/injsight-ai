# InjSight AI UX/UI Specification — Rate Limiting

## 1. Feature Overview

**Feature:** Rate Limiting  
**Category:** Abuse prevention UX  
**Primary Route / Placement:** `Global/API error state`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Show usage limits and rate-limit errors clearly.
...
Once you use Rate Limiting, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/RateLimiting.tsx
frontend/types/rate_limiting.ts
frontend/data/mock_rate_limiting.ts
```
