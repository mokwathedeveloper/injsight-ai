# InjSight AI UX/UI Specification — Usage Analytics

## 1. Feature Overview

**Feature:** Usage Analytics  
**Category:** Product analytics  
**Primary Route / Placement:** `/admin/analytics`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Track wallet analyses, reports, conversion, and plan usage.
...
Once you use Usage Analytics, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/UsageAnalytics.tsx
frontend/types/usage_analytics.ts
frontend/data/mock_usage_analytics.ts
```
