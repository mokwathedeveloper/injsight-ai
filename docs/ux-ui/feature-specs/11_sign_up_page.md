# InjSight AI UX/UI Specification — Sign-Up Page

## 1. Feature Overview

**Feature:** Sign-Up Page  
**Category:** Auth conversion  
**Primary Route / Placement:** `/signup`  
**Product:** InjSight AI  
**Product Subtitle:** AI Wallet Intelligence for Injective DeFi  

## 2. Purpose

Convert visitors into users after analysis or from the landing page.
...
Once you use Sign-Up Page, relevant wallet intelligence will appear here.
...
```txt
frontend/components/dashboard/SignUpPage.tsx
frontend/types/sign_up_page.ts
frontend/data/mock_sign_up_page.ts
```
